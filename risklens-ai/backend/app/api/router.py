...
from app.api.v1 import portfolio, risk, alerts, config, audit, health, market, agent
...
api_router.include_router(agent.router, prefix="/rebalance", tags=["Agentic Execution"])
